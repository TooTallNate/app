...
import { useScorecardJobs } from "../contexts/jobs";

interface ScorecardJobSelectorProps
  extends Omit<
...
const ScorecardJobSelector: React.FC<ScorecardJobSelectorProps> = ({
  value,
  onChange = () => {},
  ...props
}) => {
  const { data: { jobs = [] } = {} } = useScorecardJobs();
...
export default ScorecardJobSelector;
